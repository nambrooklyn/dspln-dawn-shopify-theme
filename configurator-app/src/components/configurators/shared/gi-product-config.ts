...
export const GI_PRODUCT_CONFIGS = {
  ...
  'mens-kimono': {
    ...
    shopifyProductPath: '/products/kimono',
    shopifyProductHandle: 'kimono',
    shopifyProductUrl: 'https://dspln.com/products/kimono',
    modelUrl: '/models/fixed-sleeev-model-suit-2024.glb',
  ...
  'mens-pant': {
    ...
    shopifyProductPath: '/products/pant',
    shopifyProductHandle: 'pant',
    shopifyProductUrl: 'https://dspln.com/products/pant',
    modelUrl: '/models/fixed-sleeev-model-suit-2024.glb',
