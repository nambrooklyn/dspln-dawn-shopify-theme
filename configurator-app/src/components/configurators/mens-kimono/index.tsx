...
const GiConfiguratorInner = memo(() => {
  ...
  const handleGenerateTechPack = useGenerateTechPack('mens-kimono', serialize, { logoMap: { kimono: kimonoLogos, pant: pantLogos } }, uploadedLogos.reduce<Record<string, any>>((acc, logo) => {
