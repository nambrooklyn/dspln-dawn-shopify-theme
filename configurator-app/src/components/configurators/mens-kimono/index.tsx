...
const GiConfiguratorInner = memo(() => {
  ...
  const handleSaveDesign = useCallback(async (
    ...
    try {
      ...
      const cloudDraft = await saveGiCloudDesign(draft, ownerForSave).catch(
        () => null,
      );
      if (cloudDraft) {
  ...
  const handleGenerateTechPack = useGenerateTechPack('mens-kimono', serialize, { kimono: kimonoLogos, pant: pantLogos }, currentDesignId, (currentDesignName || undefined));
 ...
 */
export const MensKimonoConfigurator = memo(() => (
  <GiStateProvider>
    <GiConfiguratorInner />
  </GiStateProvider>
));

MensKimonoConfigurator.displayName = 'MensKimonoConfigurator';
