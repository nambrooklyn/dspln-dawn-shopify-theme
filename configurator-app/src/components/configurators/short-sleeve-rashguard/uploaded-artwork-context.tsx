 ...
 * configurator root by useUploadedArtwork). The artwork upload section
 * reads it to offer "pick from your uploads" alongside the device file
 * picker; an empty list means the chooser stays hidden and uploads
 * behave as a plain file input.
 */
