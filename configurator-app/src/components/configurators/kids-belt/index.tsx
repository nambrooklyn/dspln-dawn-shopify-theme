...
const PRODUCT_CONFIG = GI_PRODUCT_CONFIGS['kids-belt'];
...
const GiConfiguratorInner = memo(() => {
  ...
  const handleGenerateTechPack = useGenerateTechPack('kids-belt', serialize, { kimono: kimonoLogos, pant: pantLogos }, currentDesignId, (currentDesignName || undefined));
 ...
 */
export const KidsBeltConfigurator = memo(() => (
  <GiStateProvider>
    <GiConfiguratorInner />
  </GiStateProvider>
));

KidsBeltConfigurator.displayName = 'KidsBeltConfigurator';
