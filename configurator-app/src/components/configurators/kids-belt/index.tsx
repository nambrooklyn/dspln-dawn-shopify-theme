...
const GiConfiguratorInner = memo(() => {
  ...
  const handleGenerateTechPack = useGenerateTechPack('kids-belt', serialize, { logoMap: { kimono: kimonoLogos, pant: pantLogos } }, uploadedLogos.reduce<Record<string, any>>((acc, logo) => {
