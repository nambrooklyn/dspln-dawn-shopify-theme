export const RASHGUARD_MODEL_URL =
  '/models/long-sleeve-rashguard.glb?v=20260630-body';

// The real stitch geometry, exported separately from THIS model and decimated
// (~1.2M → ~840k tris at ratio 0.70) so it's light. Grafted onto the body at the
// exact same coordinates it came from, so the alignment is pixel-perfect.
export const RASHGUARD_STITCH_GRAFT_URL =
  '/models/long-sleeve-rashguard-stitch.glb?v=20260630-stitch';

export const RASHGUARD_PRODUCT_CONFIG = {
  productName: 'Long Sleeve Rashguard',
  productTitle: 'Custom Long Sleeve Rashguard',
  shopifyProductPath: '/products/custom-long-sleeve-rashguard',
  shopifyProductHandle: 'custom-long-sleeve-rashguard',
  designNamePrefix: 'Long Sleeve Rashguard Design',
  savedDesignIdPrefix: 'long_sleeve_rashguard_saved',
  orderDesignIdPrefix: 'long_sleeve_rashguard_order',
  localStorageKey: 'dspln:long-sleeve-rashguard-designs:v1',
  autoDraftStorageKey: 'dspln:long-sleeve-rashguard-autosave:v1',
  cartStorageKey: 'dspln:long-sleeve-rashguard-test-cart',
  configStoragePrefix: 'dspln:long-sleeve-rashguard-config:',
  netlifyPath: '/configurator/long-sleeve-rashguard',
};
