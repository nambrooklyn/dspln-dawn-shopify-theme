...
const GiConfiguratorInner = memo(() => {
  ...
  const handleAddToCart = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        console.error('[WomensGiConfigurator] Cloud design save failed', err);
      ...
      console.log('[WomensGiConfigurator] Shopify cart line:', line);
  ...
  const handleGenerateTechPack = useGenerateTechPack('womens-gi', serialize, { kimono: kimonoLogos, pant: pantLogos }, currentDesignId, (currentDesignName || undefined));
 ...
 */
export const WomensGiConfigurator = memo(() => (
  <GiStateProvider>
    <GiConfiguratorInner />
  </GiStateProvider>
));

WomensGiConfigurator.displayName = 'WomensGiConfigurator';
