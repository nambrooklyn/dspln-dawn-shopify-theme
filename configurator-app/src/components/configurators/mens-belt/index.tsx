...
const GiConfiguratorInner = memo(() => {
  ...
  const handleGenerateTechPack = useGenerateTechPack('mens-belt', serialize, { kimono: kimonoLogos, pant: pantLogos }, currentDesignId, (currentDesignName || undefined));
 ...
 */
export const MensBeltConfigurator = memo(() => (
  <GiStateProvider>
    <GiConfiguratorInner />
  </GiStateProvider>
));

MensBeltConfigurator.displayName = 'MensBeltConfigurator';
