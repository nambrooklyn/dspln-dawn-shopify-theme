...
import { GiStateProvider, useGiState } from '../kids-gi/gi-state';
import type { GiSerializedState } from '../kids-gi/gi-state';
import type { CameraView } from '../kids-gi/gi-config';
import {
  AUTO_GI_DRAFT_ID,
...
import { listGiCloudDesigns } from '../kids-gi/gi-cloud-designs';
import { UploadedLogosProvider } from '../kids-gi/uploaded-logos-context';
import { useUploadedLogos } from '../kids-gi/use-uploaded-logos';
  ...
  const handleAddToCart = useCallback(async () => {
    ...
    try {
      ...
      const line = buildShopifyTestCartLine({
        // Typed against the mens pipeline's serialized state; wire-compatible.
