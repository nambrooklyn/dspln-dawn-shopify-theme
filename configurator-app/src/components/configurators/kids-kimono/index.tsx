...
const GiConfiguratorInner = memo(() => {
  ...
  const handleGenerateTechPack = useGenerateTechPack('kids-kimono', serialize, { logoMap: { kimono: kimonoLogos, pant: pantLogos } }, uploadedLogos.reduce<Record<string, any>>((acc, logo) => {
