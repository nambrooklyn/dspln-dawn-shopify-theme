...
const GiConfiguratorInner = memo(() => {
  ...
  const handleGenerateTechPack = useGenerateTechPack('kids-kimono', serialize, { kimono: kimonoLogos, pant: pantLogos }, currentDesignId, (currentDesignName || undefined));
 ...
 */
export const KidsKimonoConfigurator = memo(() => (
  <GiStateProvider>
    <GiConfiguratorInner />
  </GiStateProvider>
));

KidsKimonoConfigurator.displayName = 'KidsKimonoConfigurator';
