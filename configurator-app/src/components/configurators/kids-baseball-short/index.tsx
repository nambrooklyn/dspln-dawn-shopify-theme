    ...
    const timeout = window.setTimeout(async () => {
      try {
        ...
        const draft = await createRashguardDraftDocument({
          ...
          name: 'Autosaved Kids Baseball Short Draft',
          spec: serialize(),
          artworkLayers,
...
export const KidsBaseballShortConfigurator = memo(() => (
  <RashguardStateProvider>
    <RashguardConfiguratorInner />
  </RashguardStateProvider>
));

KidsBaseballShortConfigurator.displayName =
  'KidsBaseballShortConfigurator';
