...
export const BELT_COLOR_SWATCHES = [
  { name: 'White', hex: '#ffffff', stripeHex: '#ffffff' },
  { name: 'Gray', hex: '#8a8d91', stripeHex: '#8a8d91' },
  { name: 'Gray/White', hex: '#8a8d91', stripeHex: '#ffffff' },
  { name: 'Gray/Black', hex: '#8a8d91', stripeHex: '#111111' },
  { name: 'Yellow', hex: '#f0c537', stripeHex: '#f0c537' },
  { name: 'Yellow/White', hex: '#f0c537', stripeHex: '#ffffff' },
  { name: 'Yellow/Black', hex: '#f0c537', stripeHex: '#111111' },
  { name: 'Orange', hex: '#d76d24', stripeHex: '#d76d24' },
  { name: 'Orange/White', hex: '#d76d24', stripeHex: '#ffffff' },
  { name: 'Orange/Black', hex: '#d76d24', stripeHex: '#111111' },
  { name: 'Green', hex: '#2f7d3f', stripeHex: '#2f7d3f' },
  { name: 'Green/White', hex: '#2f7d3f', stripeHex: '#ffffff' },
  { name: 'Green/Black', hex: '#2f7d3f', stripeHex: '#111111' },
] as const;
...
export type KidsBeltRankName = (typeof BELT_COLOR_SWATCHES)[number]['name'];

export function beltSwatchForName(name: string) {
  return BELT_COLOR_SWATCHES.find((swatch) => swatch.name === name);
}
...
export const KIMONO_MESH_TO_SUBPART: Record<string, KimonoSubPart> = {
  ...
  Kimono_Reinforcement_5: 'reinforcement',
  Kimono_Reinforcement_6: 'reinforcement',
  Kimono_Reinforcement_7: 'reinforcement',
  Kimono_Reinforcement_8: 'reinforcement',
  Kimono_Reinforcement_9: 'reinforcement',
  Kimono_Reinforcement_10: 'reinforcement',
  Kimono_Stitching: 'stitching',
  Kimono_Stitching_1: 'stitching',
  Kimono_Stitching_2: 'stitching',
  Kimono_Stitching_3: 'stitching',
  Kimono_Stitching_4: 'stitching',
  Kimono_Stitching_5: 'stitching',
  Kimono_Stitching_6: 'stitching',
  Kimono_Stitching_7: 'stitching',
};
...
export const PANT_MESH_TO_SUBPART: Record<string, PantSubPart> = {
  ...
  Pant_Reinforcement_1: 'reinforcement',
  Pant_Reinforcement_2: 'reinforcement',
  Pant_Stitching: 'stitching',
  Pant_Stitching_1: 'stitching',
  Pant_Stitching_2: 'stitching',
  Pant_Stitching_3: 'stitching',
  Pant_Stitching_4: 'stitching',
  Pant_Stitching_5: 'stitching',
  Pant_Stitching_6: 'stitching',
};
...
// Standalone pant product: cardinals frame the pants.
  front: [0, 0.7, 2.2],
  back: [0, 0.7, -2.2],
  left: [-2.2, 0.7, 0],
  right: [2.2, 0.7, 0],
...
export const GI_MODEL_URL = GI_PRODUCT_CONFIGS['kids-pant'].modelUrl;
