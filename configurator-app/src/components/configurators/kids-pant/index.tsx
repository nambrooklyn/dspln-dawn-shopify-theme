...
const GiConfiguratorInner = memo(() => {
  ...
  const handleGenerateTechPack = useGenerateTechPack('kids-pant', serialize, { kimono: kimonoLogos, pant: pantLogos }, currentDesignId, (currentDesignName || undefined));
      ...
      <ConfiguratorShell
        ...
        sceneTopContent={
          <>
            {cloudOwnerContext?.isCustomer ? (
              <div
                className="mb-2 flex max-w-[32rem] items-center gap-4 text-[9px] font-semibold tracking-[0.14em] uppercase"
 ...
 */
export const KidsPantConfigurator = memo(() => (
  <GiStateProvider>
    <GiConfiguratorInner />
  </GiStateProvider>
));

KidsPantConfigurator.displayName = 'KidsPantConfigurator';
